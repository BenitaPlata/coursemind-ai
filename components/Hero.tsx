    ...
    >
      ...
      <div className="relative z-10 max-w-4xl text-center">
        ...
        <p className="text-base md:text-lg text-[var(--text-dim)] max-w-xl md:max-w-2xl mx-auto mb-10 px-2">
          Convierte cualquier curso en una base de conocimiento con IA
          y crea un tutor inteligente capaz de responder preguntas
          utilizando el contenido real de las clases.
        </p>
